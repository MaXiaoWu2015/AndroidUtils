...
import com.example.xiaowu.AndroidDataStorage.DataBase.greendao.Channel;
...
public class ChannelDao extends AbstractDao<Channel, Long> {
    ...
    public static class Properties {
        ...
        public final static Property IsOrdered = new Property(2, int.class, "isOrdered", false, "IS_ORDERED");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CHANNEL\" (" + //
                ...
                "\"NAME\" TEXT," + // 1: name
                "\"IS_ORDERED\" INTEGER NOT NULL );"); // 2: isOrdered
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Channel entity) {
        ...
        stmt.bindLong(3, entity.getIsOrdered());
    }
    ...
    @Override
    protected final void attachEntity(Channel entity) {
    ...
    public Channel readEntity(Cursor cursor, int offset) {
        Channel entity = new Channel( //
            ...
            cursor.getInt(offset + 2) // isOrdered
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Channel entity, int offset) {
        ...
        entity.setIsOrdered(cursor.getInt(offset + 2));
     }
