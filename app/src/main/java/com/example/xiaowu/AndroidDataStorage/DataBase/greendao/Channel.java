...
public class Channel {
    ...
    @ToMany(referencedJoinProperty = "msg_channel_id")
    ...
    @Generated(hash = 816160656)
    public Channel(Long Id, String name, int isOrdered) {
        this.Id = Id;
        this.name = name;
    ...
    public List<Message> getMessageList() {
        if (messageList == null) {
            ...
            List<Message> messageListNew = targetDao._queryChannel_MessageList(Id);
            synchronized (this) {
                if(messageList == null) {
